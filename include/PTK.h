...
#define PREFETCH_BS
#define VERBOSE_PERIODIC_LID

#define VERBOSE_SEARCH_PATH
// #define CATCH_CACHE_MISS_PAPI
// #define CATCH_CACHE_MISS_LINUXPERF
...
namespace PTK {
    ...
    typedef struct querying_stats{
        ...
        size_t l3_cache_misses;


        bool collect_path_data;
        std::vector<unsigned> search_path_ids;
        std::vector<float> search_path_distances;
        querying_stats()
        {
            ...
            time_cnmd = 0;
            time_leaves_search = 0;
            time_update_knn = 0;
            time_routing = 0;
            time_layer0 = 0;
            time_pq = 0;
            saxdist_computations_bsl = 0;
            saxdist_computations_hsl = 0;
            l1_cache_misses=0;
            l2_cache_misses= 0;
            l3_cache_misses= 0;
